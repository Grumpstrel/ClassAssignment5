...
namespace CarRentalApp
{
    class PrintConsole
    {
        ...
        //public static void PrintCustomerAccount(string customerEmailAddress)
        //{
        //    var getaccount = CustomerAccounts.GetAllAccounts(customerEmailAddress);
        //    {

        //        Console.WriteLine($"Account Number: {getaccount.},");
